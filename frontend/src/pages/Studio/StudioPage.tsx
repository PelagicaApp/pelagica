...
StudioPageSkeleton.displayName = 'StudioPageSkeleton';
...
const StudioPage = () => {
    ...
    return (
        <Page
            ...
            pagePadding
        >
            {isLoading && <StudioPageSkeleton />}
            {error && <p>Error loading item details.</p>}
            {item && <ItemsListPage item={item} useItems={useStudioItems} />}
        </Page>
    );
};
